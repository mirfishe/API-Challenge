...
function buildResultsArray(data) {
    //console.log(data);
    ...
    results.forEach(element => {
        ...
        let URL = pokemonURL + element.name;
        ...
        .then(data => {
            ...
            //console.log(displayPokemon2(data, "front_default"));

            resultsArray.push({name:  element.name, front_default: data.sprites.front_default,});
...
function displayResults2(){
    ...
    resultsArray.forEach(element => {
        ...
        // Display images
        //getPokemon2(element.name);

        let pokemonIMG = document.createElement("img");
        pokemonIMG.src = getPokemon2(element.name);
        //console.log(getPokemon2(element.name));
...
function getPokemon2(name){
    ...
    .then(data => {
        ...
        console.log(displayPokemon2(data, "front_default"));
        return displayPokemon2(data, "front_default");
    })
    .catch(err => {
        console.log(err)
        errorHeader.innerText = err;
...
function displayPokemon2(data, spriteName){
    //console.log(data);
    ...
    if (sprites.front_default !== "" && spriteName === "front_default") {
